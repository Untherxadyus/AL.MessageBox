...
namespace PAS.MessageBox
{
    public class MsgBox : Form
    {
        ...
        public static DialogResult ShowError(string message)
        {
            _msgBox = new MsgBox();
            _msgBox._lblMessage.Text = message;
            _msgBox._lblTitle.Text = "Error";

            MsgBox.InitButtons(MsgBox.Buttons.OK);
            MsgBox.InitIcon(MsgBox.Icon.Error);
        ...
        public static DialogResult ShowMessage(string message)
        {
            _msgBox = new MsgBox();
            _msgBox._lblMessage.Text = message;
            _msgBox._lblTitle.Text = "Informacion";

            MsgBox.InitButtons(MsgBox.Buttons.OK);
            MsgBox.InitIcon(MsgBox.Icon.Info);
